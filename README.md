...
This project pairs with [irchub](https://github.com/robertclemens/irchub) — a hub server for centralized management of IRC bot networks. irchub handles keypair generation, encrypted config distribution, and multi-bot coordination.
